/* original https://github.com/john-doherty/long-press-event
@author John Doherty,  MODIFIED for Blazor by eMeL
@license MIT */

'use strict';

// function emelLongPressEvent(window, document)
function emelLongPressEvent()
{
